                ...
                <div class="page-wrapper">
                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <form action="/packet/{{ $packet->id}}" method="POST">
                            @csrf
                            @method('put')
                                <div class="form-group row">
                                    <label for="packetName" class="col-sm-2 col-form-label">Nama Paket</label>
                                    <div class="col-sm-10">
                                        <input name="packetName" id="packetName" value="{{ old('packetName', $packet->packetName)}}" type="text" class="text-uppercase form-control @error('packetName') form-control-danger @enderror" required>
                                    </div>
                                </div>
                                @error('packetName')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="packetPrice" id="packetPrice" value="{{ old('packetPrice', $packet->packetPrice)}}" type="number" class="form-control @error('packetPrice') form-control-danger @enderror" required>
                                    </div>
                                </div>
                                @error('packetPrice')
                                    <label class="md-line label-danger"><strong>{{ $message }}</strong></label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="packetDes" id="packetDes" rows="5" cols="5" class="form-control @error('packetDes') form-control-danger @enderror" required>{{ old('packetDes', $packet->packetDes)}}</textarea>
                                    </div>
                                </div>
                                @error('packetDes')
                                    <label class="md-line label-danger"><strong>{{ $message }}</strong></label>
